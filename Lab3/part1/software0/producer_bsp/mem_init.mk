...
$(MEM_0)_HIERARCHICAL_PATH := data_mem0
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: data_mem0
data_mem0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: ins_mem0
MEM_1 := SoC_ins_mem0
$(MEM_1)_NAME := ins_mem0
...
$(MEM_1)_HIERARCHICAL_PATH := ins_mem0
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: ins_mem0
ins_mem0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: shared_mem
MEM_2 := SoC_shared_mem
$(MEM_2)_NAME := shared_mem
...
$(MEM_2)_END := 0x0003ffef
$(MEM_2)_HIERARCHICAL_PATH := shared_mem
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: shared_mem
shared_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
